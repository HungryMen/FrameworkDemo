...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewsStore = __webpack_require__(178);
	var NewsAction = __webpack_require__(180);
	...
	var App = React.createClass({
	    ...
	    render: function render() {
	        var rows = this.state.list.map(function (v) {
	            return React.createElement(NewsRow, { title: v.title, content: v.content });
	        });
	        return React.createElement(
	            'ul',
	            { className: 'news-list' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewsActions = __webpack_require__(180);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var NewsActions = Reflux.createActions(["load" //called when entering the page
	]);
